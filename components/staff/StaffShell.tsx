...
function SidebarContent({
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Profile */}
      <div className="px-5 py-4 border-b border-primary-700/50 dark:border-neutral-800 flex-shrink-0">
        <p className="font-semibold text-sm truncate">{nama}</p>
        <span className={cn('inline-block text-xs font-medium px-2 py-0.5 rounded-full mt-1', ROLE_COLOR[role])}>
          {ROLE_LABEL[role]}
        </span>
      </div>
      ...
      {/* Footer */}
      <div className="px-3 py-3 border-t border-primary-700/50 dark:border-neutral-800 flex-shrink-0 space-y-1">
        <button
